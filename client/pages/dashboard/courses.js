  ...
  return (
    <DashboardLayout title="Explore Courses">
      <div className="max-w-4xl mx-auto animate-fade-in space-y-5">
        ...
        {/* Smaller Course Card */}
        <div className="glass rounded-xl overflow-hidden shadow-sm border border-slate-200 group flex flex-col sm:flex-row bg-white max-w-2xl">
          ...
          <div className="w-full sm:w-1/3 relative bg-slate-900 overflow-hidden flex items-center justify-center p-6 min-h-[200px]">
            ...
            <div className="relative z-10 text-center">
                <div className="w-12 h-12 mx-auto bg-blue-500 rounded-xl flex items-center justify-center mb-3 shadow-lg shadow-blue-500/30">
          ...
          <div className="w-full sm:w-2/3 p-5 flex flex-col justify-between">
            <div>
                ...
                <h3 className="text-base font-700 mb-2 text-slate-900" style={{ fontFamily: 'Sora,sans-serif' }}>The Complete Full Stack Developer Program</h3>
                ...
                <div className="grid grid-cols-2 gap-y-2 gap-x-2 text-[11px] text-slate-700 mb-5 font-500">
            ...
            <div className="flex gap-2 pt-4 border-t border-slate-100 mt-auto">
                ...
                <button className="flex-1 btn-secondary justify-center py-2 text-xs font-600 bg-white" onClick={() => alert('Starting your free trial!')}>
                    Free Trial
                </button>
            </div>
          </div>
