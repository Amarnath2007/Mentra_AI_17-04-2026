  ...
  return (
    <DashboardLayout title="Daily Fun Facts">
      <div className="max-w-5xl mx-auto space-y-6 animate-fade-in">
        ...
        {/* Header Section */}
        <div className="glass rounded-2xl p-8 flex flex-col md:flex-row gap-6 items-center justify-between border border-blue-100 dark:border-blue-900/30 bg-white dark:bg-slate-900 relative overflow-hidden">
          ...
          <div>
            ...
            <button 
              ...
              disabled={refreshing}
              className="inline-flex items-center gap-2 text-xs font-600 text-blue-600 hover:text-blue-700 transition-colors px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/30 hover:bg-blue-100"
            >
              <RotateCw size={14} className={refreshing ? 'animate-spin' : ''} />
              {refreshing ? 'Regenerating...' : 'Not relevant? Refresh facts'}
            </button>
          </div>
          <div className="flex-shrink-0 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-2xl border border-blue-100 dark:border-blue-900/30">
        ...
        <div className="p-2">
          {!dailyInsight && loadingProfile ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
              {facts.map((fact, i) => (
                <div key={i} className="relative group p-7 rounded-[2rem] border border-slate-100 dark:border-slate-700 transition-all hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-500/10 bg-white dark:bg-slate-900 shadow-sm overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="w-12 h-12 rounded-2xl bg-blue-600 text-white flex items-center justify-center mb-6 shadow-lg shadow-blue-200 dark:shadow-blue-900/30">
                      <Lightbulb size={24} />
                    </div>
                    <p className="text-lg text-slate-800 dark:text-slate-100 leading-relaxed font-600" style={{ fontFamily: 'Sora,sans-serif', fontWeight: 600 }}>
                      {fact}
                    </p>
            ...
            <div className="glass rounded-2xl p-16 text-center border border-slate-100 dark:border-slate-700">
              <div className="w-20 h-20 bg-blue-50 dark:bg-blue-900/20 rounded-full flex items-center justify-center mx-auto mb-6">
                <Sparkles size={32} className="text-blue-400" />
              </div>
              <h3 className="text-xl font-700 mb-2">Generating Today's Facts</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm">Our AI is curatoring something special for you based on your interests...</p>
            </div>
          )}
        </div>
